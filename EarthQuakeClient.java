...
public class EarthQuakeClient {
    ...
    public void quakesOfDepth(){
        ...
        ArrayList<QuakeEntry> depthList = filterByDepth(list , -10000.0 , -5000.0);
    ...
    public void quakesByPhrase(){
        ...
        ArrayList<QuakeEntry> tittleList1 = filterByPhrase(list , "start" , "California");
        for(QuakeEntry qe : tittleList1){
            System.out.println(qe);
            
        }
        System.out.println("From End");
        ArrayList<QuakeEntry> tittleList2 = filterByPhrase(list , "end" , "California");
        ...
        ArrayList<QuakeEntry> tittleList3 = filterByPhrase(list , "any" , "California");
